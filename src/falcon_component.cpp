...
{
    template <>
    void FalconComponent::configure_current_limit(TalonFXConfiguration &config)
    {
    ...
    template <>
    void FalconComponent::configure_sensor()
    {
    ...
    template <>
    double FalconComponent::get_output_current()
    {
...
RCLCPP_COMPONENTS_REGISTER_NODE(ros_phoenix::FalconComponent)